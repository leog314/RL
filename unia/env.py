...
class Env:
    def __init__(self, build: str, state_hst_size: int = 4, image_shape: tuple | torch.Tensor = (62, 62)):
        self.env = gym.make(build, render_mode = "human")
        self.shape = ()
        self.state_hy_size = state_hst_size
        self.state_hyst = []
        self.img_shape = image_shape

    def obs_to_tensor(self, obs) -> torch.Tensor:
    ...
    def start_mdp(self):
        ...
        init_state = rgb_to_grayscale(self.obs_to_tensor(init_obs[0]))
    ...
    def step(self, action: int):
        ...
        state = rgb_to_grayscale(self.obs_to_tensor(obs))
